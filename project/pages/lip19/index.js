...
import styles from ".//lip19.module.css";
import Link from "next/link";
export default function lip19(){
    return(
        <div>
            <Navigator2/>
            ...
            <div className={styles.d}>
                Brand : 2P Original Oh My Tint Velvet And Smooth<br></br>Color : OMT 10 #EF6577<br></br>Tone : Cool Tone<br></br>Glowy : 0/5<br></br>Matte : 5/5<br></br>Long Lasting : 2/5
            </div>
