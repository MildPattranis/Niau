...
import styles from ".//lip14.module.css";
import Link from "next/link";
export default function lip14(){
    return(
        <div>
            <Navigator2/>
            ...
            <div className={styles.d}>
                Brand : BBIA Glow Lip Tint<br></br>Color : 04 Cinnamon #A33938<br></br>Tone : Natural Tone<br></br>Glowy : 5/5<br></br>Matte : 0/5<br></br>Long Lasting : 4/5
            </div>
