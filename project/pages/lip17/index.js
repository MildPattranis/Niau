...
import styles from ".//lip17.module.css";
import Link from "next/link";
export default function lip17(){
    return(
        <div>
            <Navigator2/>
            ...
            <div className={styles.d}>
                Brand : KATE Lip Monster<br></br>Color : 13 Tispy at 3:00 #ED8BAD<br></br>Tone : Cool Tone<br></br>Glowy : 4/5<br></br>Matte : 0/5<br></br>Long Lasting : 5/5
            </div>
