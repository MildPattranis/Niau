...
import styles from ".//lip13.module.css";
import Link from "next/link";
export default function lip13(){
    return(
        <div>
            <Navigator2/>
            ...
            <div className={styles.d}>
                Brand : Barenbliss Peach Makes Perfect Lip Tint<br></br>Color : 05 Good Vibes #C76662<br></br>Tone : Natural Tone<br></br>Glowy : 5/5<br></br>Matte : 0/5<br></br>Long Lasting : 4/5
            </div>
